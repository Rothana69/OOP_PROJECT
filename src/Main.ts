...
// ====Passenger====
let passenger1 = new Passenger("To", "YaTa", Gender.MALE, date1, "02342423", "tato@gmail.com", Meal.DAIRY_FREE);
let passenger2 = new Passenger("Ka", "KITO", Gender.FEMALE, date2, "01243543", "tota@gmail.com", Meal.DAIRY_FREE);
// ====Booking Trip====
...
// ====AirLine Manager====
let airline = new Airline("Ma");

// =========Airport =================================================================
let airport1 = new Airport("Phnom Penh Airport");
// ====Call Function====
...
airline.passengersReturnTicket(flight2);
...
airline.addEmployee(employees2)
airport1.addAirline(airline)
// ====Console====
// console.log(airline.getPassengersWithReturnTicket());
// console.log(Aeroplane1.getFlight());
// passenger1.findBookingTrip(Aeroplane2);
// console.log(airport1.getPassengerTripInfo("12A"));
// console.log(airline.getFlights(pilot1 , date1));
console.log(airline.getAllSalary());
